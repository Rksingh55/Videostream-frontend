		...
		<>
			<div class="grid-container">
				<div class="grid-item first">
					<div className='logow' ><Grid item

					>
						{config.logo ?
							<img alt='Logo' src={config.logo} className='icon' /> :
							<Typography variant='h5'> {config.title} </Typography>
						}
					</Grid></div>
				</div>
				<div class="grid-item loginform1">
					...
					<div className='loginform'>
						...
						<DialogContent>
							...
							<input
								placeholder='Your Meeting Room Name'
								autoFocus
								id='roomId'
									...
									<Grid item>
										<FormControl component='fieldset'>
											...
											>
												...
												<ToggleButton value='{"audio":true,"video":true}' style={{ color: "black", backgroundColor: "#FCC722" }}>
													<Tooltip title={intl.formatMessage({
													...
													{(popupState) => (
														<React.Fragment>
															<Button
																...
																color='black'
																disableRipple
																style={{ backgroundColor: '#FCC722', color: "black" }}
