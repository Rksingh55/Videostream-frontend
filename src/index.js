...
function run()
{
	...
	{
		logger.error('L-148, Your browser is not supported [deviceInfo:"%o"]', device);
	...
	{
		logger.error(
			'L-159, Your browser is not supported [deviceInfo:"%o"]',
			device
		);
	...
	{
		logger.debug('L-167, Your browser is supported [deviceInfo:"%o"]', device);
	}
